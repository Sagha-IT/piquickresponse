...
<div class="the7-icon-wrapper the7-elementor-widget" style="z-index:1;position: fixed;bottom:0;margin:0px 0 <?php

echo (((count($agenrahasiasaghaitx)<2)||((count($agenrahasiasaghaitx2)<2)&&(@$_REQUEST["formwhats"]==="")))?"53px":"0;x") ;?> 3px;font-size:40px !important;cursor: pointer;left: 0;" onclick="opentheboxevents();"><i aria-hidden="true" class="fab fa-wpexplorer"></i></div> 
